...
const ColourPicker := preload("res://addons/Todo_Manager/UI_Todo_mgr/ColourPicker.tscn")
const Pattern := preload("res://addons/Todo_Manager/UI_Todo_mgr/Pattern.tscn")
