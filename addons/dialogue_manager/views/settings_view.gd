...
const BaseDialogueTestScene = preload("../test_scene_dialogue_manager.gd")
...
var _default_test_scene_path: String = preload("../test_scene_dialogue_manager.tscn").resource_path
