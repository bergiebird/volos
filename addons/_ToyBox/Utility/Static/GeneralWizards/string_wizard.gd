...
extends RefCounted # string_wizard.gd



#region Label Helper
## Adjusts the size and wrapping of text in a label procedurally
...
static func remove_whitespaces(text: String) -> String:
	...
	return StringWizard.str_replace(text, whitespace_regex, func(_text: String): return "")
