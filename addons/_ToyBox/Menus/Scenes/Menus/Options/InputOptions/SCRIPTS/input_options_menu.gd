...
func _add_input_event_as_tree_item(action_name : String, input_event : InputEvent, parent_item : TreeItem):
	...
	input_tree_item.set_text(0, InputWizard.get_text(input_event))
...
func _assign_input_event(input_event : InputEvent, action_name : String):
	assigned_input_events[InputWizard.get_text(input_event)] = action_name
...
func _remove_input_event(input_event : InputEvent):
	assigned_input_events.erase(InputWizard.get_text(input_event))
...
func _get_action_for_input_event(input_event : InputEvent) -> String:
	if InputWizard.get_text(input_event) in assigned_input_events:
		return assigned_input_events[InputWizard.get_text(input_event)]
	return ""
